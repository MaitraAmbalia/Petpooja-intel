...
# 3. Function to find an item based on High/Low strategies using Weighted Orders
...
for config in combo_configs:
    ...
    avg_weighted_orders = (snack['Weighted_Orders'] + dessert['Weighted_Orders']) / 2
...
combos_df.to_csv("Strategic_Discounted_Combos_Snacks_Desserts_Weighted.csv", index=False)